...
statement: var assign expression {printf("statement -> var assign expression \n");}
			...
			| read var var_p {printf("statement -> read var var_p \n");}
			| write var var_p {printf("statement -> write var var_p \n");}
...
relation_n_exp: relation_exp relation_n_exp1 {printf("relation_n_exp -> relation_exp \n");};

relation_n_exp1: and relation_exp relation_n_exp1 {printf("relation_n_exp1 -> and relation_exp relation_n_exp1 \n");}
...
bool_exp: relation_n_exp bool_exp1 {printf("bool_exp -> relation_n_exp bool_exp1 \n");};

bool_exp1: or relation_n_exp bool_exp1 {printf("bool_exp1 -> or relation_n_exp bool_exp1 \n");}
			| {printf("bool_exp1 -> \n");};
